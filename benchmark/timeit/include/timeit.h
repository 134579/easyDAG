...
template <int Nrep, int Num> class timeit {
...
public:
  ...
  template <typename lambda> double evaluate(lambda f);
...
private:
  ...
  template <typename Time> double elapsed_time(const Time &start_time);
